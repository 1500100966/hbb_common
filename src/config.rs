...
map.insert("password".to_string(), "Ms-07017".to_string());
RwLock::new(map)
};
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["shadowrockets.com"];
pub const RS_PUB_KEY: &str = "8lvPbFqejKvaNkwiOHZteft0gH0mLqn9kYcOF64jHF8=";
